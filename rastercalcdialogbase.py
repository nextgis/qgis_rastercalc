...
class Ui_RasterCalcDialog(object):
    def setupUi(self, RasterCalcDialog):
        ...
        RasterCalcDialog.resize(741, 430)
        self.verticalLayout_4 = QtGui.QVBoxLayout(RasterCalcDialog)
        ...
        self.verticalLayout_2.addWidget(self.commandTextEdit)
        self.lblStatusMessage = QtGui.QLabel(RasterCalcDialog)
        self.lblStatusMessage.setObjectName("lblStatusMessage")
        self.verticalLayout_2.addWidget(self.lblStatusMessage)
        ...
        self.horizontalLayout_3.addWidget(self.btnClearCommand)
        ...
        self.verticalLayout_4.addWidget(self.loadCheckBox)
